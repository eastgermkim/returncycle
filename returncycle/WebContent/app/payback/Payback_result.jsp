...
<%@ include file = "/header.jsp" %>
	...
	<!-- Main -->
			...
			<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/main.css" />
				...
				<c:set var="p_name" value="${requestScope.p_name}"/>
	<!--수거하기 결과페이지 main-->
		<section id="banner">
 				<div class="inner"> 
					<h3>
					...
					${p_name}
 					...
 					<span style="font-size:150%">님</span></h3>
 					상품 신청이 완료되었습니다. 상품 배송기간은 <span style="color:red; font-size:140%">3~20</span>일로 예상됩니다.
 					<br><br>
