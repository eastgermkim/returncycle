...
<body class="is-preload">
	...
	<section id="main" class="wrapper style1">
		<header class="major">
			<h3>
				<span id="u_name" style="font-size: 200%;"><%=session.getAttribute("session_result")%></span> 
				<span style="font-size: 150%">님 수거완료</span>
			</h3>
			<a href="${pageContext.request.contextPath}/apply/ApplyList.ap" style="font-size: 150%;">홈으로</a>
		</header>
<!-- 		<div class="container">
				Content
				<section id="content">
